...
- [ ] Why are forms used so often in web applications and software?
    Because Forms are the only way where user can provide input to the app . like the SignIn , LogIn etc.

- [ ] What advantages are there by using a forms library like Formik?  

   Formik is a library which helps you with three most important parts.
